...
import { Shuffle, Edit, Trash, Plus, Zap, AlertCircle } from 'lucide-react';
...
// Name generator data
const NAME_PREFIXES = ['Aster', 'Atom', 'Cosmo', 'Nova', 'Orbit', 'Pulsar', 'Quark', 'Rocket', 'Solar', 'Stellar'];
const NAME_SUFFIXES = ['blast', 'flare', 'glow', 'jet', 'light', 'pulse', 'ray', 'spark', 'streak', 'wave'];
...
const EquipmentDetails = ({ character, updateCharacter }) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 text-center text-blue-900">Step 4: Equipment & Details</h2>
            ...
            <div className="grid grid-cols-3 gap-3">
              {PORTRAIT_OPTIONS.map(portrait => (
                ...
                >
                  ...
                  <div className="p-2 text-center text-sm">{portrait.name}</div>
                </div>
              ))}
            </div>
          </div>
